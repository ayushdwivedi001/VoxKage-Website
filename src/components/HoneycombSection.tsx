  ...
  return (
    ...
    >
      <div className="sticky top-0 w-full h-screen overflow-hidden flex items-center">
        ...
        {/* Using a wrapper div so we can overlay HTML nodes at matching % positions */}
        <div className="absolute left-[38%] top-0 right-0 bottom-0 z-10">
          ...
          {/* ── Peripheral nodes ── x/y here are percentages within this div */}
          {/* The div starts at left:38% of screen. 
              SVG viewBox is 0-100 across 62% of screen width.
              Node x=30 in SVG → 30% of SVG width → 30% of this div's width.
              Node x=88 in SVG → 88% of this div's width. etc. */}
          {NODES.map((node, i) => (
            <TechNode
              key={i}
              x={node.x}
